...
/**
 * Slide for application splash screens. 
 * @author simon.schwantzer(at)im-c.de
 */
public class SplashSlide extends Slide {
	private final String target;
	private final int delay;

	public SplashSlide(String id, SlideController controller, Element properties) throws IllegalArgumentException {
		super(id, SlideType.SPLASH, controller, properties);
